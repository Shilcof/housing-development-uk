class User < ActiveRecord::Base
    ...
    has_many :follower_ids, classname: :follower_developers, foreign_key: "follower_id", dependent: :destroy
    has_many :following_developer_ids, classname: :follower_developers, foreign_key: "developer_id", dependent: :destroy
